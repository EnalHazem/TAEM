...
namespace AncientEgyptianMuseum\Database\Managers;

use App\Models\Model;
use AncientEgyptianMuseum\Database\Grammars\MySQLGrammar;
use AncientEgyptianMuseum\Database\Managers\Contracts\DatabaseManager;

class MySQLManager implements DatabaseManager
{
    //singleton instance
    //this is a singleton instance of the MySQLManager class
